...
#### Week 4 (24/06/2024 - 25/06/2024)

**Summary:**
In the final week, I focused on creating an internship diary website using Mesop and Python. The website allows for uploading daily and weekly summaries and includes a chatbot to answer queries based on these entries. I improved the website's CSS for better design, uploaded it to GitHub, and hosted it using Render. Additionally, I researched how to ensure the website can function asynchronously on multiple devices.
